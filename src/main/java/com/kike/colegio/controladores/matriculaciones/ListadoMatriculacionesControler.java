...
/**
 * Servlet implementation class ListadoMatriculacionesControler
 */
@WebServlet("/matriculaciones/listadomatriculaciones")
public class ListadoMatriculacionesControler extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public ListadoMatriculacionesControler() {
		super();
