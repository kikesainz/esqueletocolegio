...
/**
 * Servlet implementation class FormularioEliminarAlumnosController
 */
@WebServlet("/alumnos/formularioeliminaralumnos")
public class FormularioEliminarAlumnosController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FormularioEliminarAlumnosController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher d = getServletContext().getRequestDispatcher("/WEB-INF/vistas/alumnos/eliminarAlumnos.jsp");
