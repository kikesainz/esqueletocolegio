...
/**
 * Servlet implementation class FormularioBorrarNotaController
 */
@WebServlet("/notas/formularioborrarnotas")
public class FormularioBorrarNotaController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FormularioBorrarNotaController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/WEB-INF/vistas/notas/borrarNotas.jsp");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(fecha.equals("")) {
			listaNotas = notasService.obtenerDatosNotasPorNombreAlumnoYNombreAsignatura(nombreAlumno, nombreAsignatura);
		} else {
			listaNotas = notasService.obtenerDatosNotasPorNombreAlumnoNombreAsignaturaYFecha(nombreAlumno, nombreAsignatura, fecha);
		}
